...
mkdir -p .repro_tmp/mp_closure
cp artifacts/stitch_constants.json .repro_tmp/mp_closure/stitch_constants.json
cp artifacts/constants_registry.json .repro_tmp/mp_closure/constants_registry.json

python3 scripts/mp_closure_guard.py       --strict-coh-zero       --registry artifacts/constants_registry.json       --stitch artifacts/stitch_constants.json       --out repro/certificate_runtime.json       --history repro/drift_guard_runs.jsonl       --pretty
