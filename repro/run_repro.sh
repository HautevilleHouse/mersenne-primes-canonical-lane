...
mkdir -p .codex_tmp/mp_closure
cp artifacts/stitch_constants.json .codex_tmp/mp_closure/stitch_constants.json
cp artifacts/constants_registry.json .codex_tmp/mp_closure/constants_registry.json
