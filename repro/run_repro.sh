...
mkdir -p .tmp/mp_closure
cp artifacts/stitch_constants.json .tmp/mp_closure/stitch_constants.json
cp artifacts/constants_registry.json .tmp/mp_closure/constants_registry.json
